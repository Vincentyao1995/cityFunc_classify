...
def timer(func):
    ...
    print("time using: %s" % str(start-end))
...
def main():
    small_img_list = []
    imgs_sub_folder_root_path = r'/home/vincent/Desktop/research/jsl_thesis/thuDateset/dataset/chaoyang/imgs/sub_regions'
    imgs_folder_path = r'/home/vincent/Desktop/research/jsl_thesis/thuDateset/dataset/chaoyang/imgs/train'
    ...
    for img in sorted(os.listdir(imgs_folder_path)):
        if img.split('.')[-1] != 'jpg':
            continue
